...
const BlogImportingOnePage: React.FC = () => {
    ...
    <>
      <div className="bg-gray-50_03 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-start justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start md:px-5 w-[57%] md:w-full">
              ...
              <div className="bg-white-A700 flex flex-col md:gap-10 gap-[375px] items-center justify-end p-[5px] w-full">
                <div className="flex flex-col gap-2 items-center justify-start mt-[19px] w-[87%] md:w-full">
                  ...
                  <div className="flex flex-row gap-1.5 items-center justify-start pr-[17px] py-[17px] w-full">
                    ...
                    <div className="flex flex-row gap-2 items-start justify-start w-[30%]">
                      <Img
                        className="h-6 w-6"
                        src="images/img_datasharingou.svg"
                        alt="datasharingOu"
                      />
                      <Text
            ...
            <div className="flex flex-1 flex-col gap-[30px] items-start justify-start md:mt-0 mt-8 pt-1.5 w-full">
              ...
              <div className="flex sm:flex-col flex-row gap-8 items-center justify-between rounded-md w-full">
                <div className="bg-gray-50 flex sm:flex-1 flex-col gap-[19px] items-center justify-center outline outline-[2px] outline-blue-A700 p-[63px] md:px-10 sm:px-5 rounded-md w-[47%] sm:w-full">
                  <Img
...
export default BlogImportingOnePage;
