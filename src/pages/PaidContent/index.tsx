        ...
        <div className="flex flex-col gap-[50px] items-center justify-start max-w-[1246px] mb-[191px] mx-auto pt-3 md:px-5 w-full">
          ...
          <div className="flex flex-col gap-[30px] items-center justify-start w-full">
            ...
            <List
              ...
              orientation="horizontal"
            >
              <div className="bg-white-A700 flex flex-1 flex-col gap-[50px] items-center justify-start p-8 sm:px-5 rounded-md shadow-bs5 w-full">
                ...
                <Button
                  className="cursor-pointer font-medium min-w-[230px] py-[17px] text-base text-center"
                  shape="round"
                  color="blue_A700"
                >
                  Create account
