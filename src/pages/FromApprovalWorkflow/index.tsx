...
const FromApprovalWorkflowPage: React.FC = () => {
          ...
          <div className="flex md:flex-col flex-row gap-[30px] items-start justify-start md:px-5 w-[95%] md:w-full">
            ...
            <div className="flex flex-1 flex-col gap-[30px] items-center justify-end w-full">
              <div className="md:h-12 h-[52px] relative w-[30%]">
                <div className="absolute bg-gray-50 border-b border-blue_gray-100 border-solid flex flex-col h-max inset-[0] items-start justify-center m-auto p-3.5 w-full">
                  <Text
                    className="md:ml-[0] ml-[26px] text-base text-blue_gray-400 w-auto"
              ...
              >
                <div className="bg-white-A700 flex flex-1 md:flex-col flex-row md:gap-5 items-end justify-start p-4 rounded-md shadow-bs1 w-full">
                  <Img
                  ...
                  <div className="flex md:flex-1 flex-col gap-5 items-end justify-start mb-0.5 md:ml-[0] ml-[209px] w-[32%] md:w-full">
                    ...
                    <div className="flex flex-row gap-4 items-center justify-between rounded-md w-full">
                      ...
                      <Button
                        className="cursor-pointer font-medium py-[17px] text-base text-center w-[150px]"
                        shape="round"
                        color="blue_A700"
                      >
                        Approve
                ...
                <div className="bg-white-A700 flex flex-1 md:flex-col flex-row md:gap-5 items-end justify-start p-4 rounded-md shadow-bs1 w-full">
                  ...
                  <div className="flex md:flex-1 flex-col gap-5 items-end justify-start mb-0.5 md:ml-[0] ml-[209px] w-[32%] md:w-full">
                    ...
                    <div className="flex flex-row gap-4 items-center justify-between rounded-md w-full">
                      ...
                      <Button
                        className="cursor-pointer font-medium py-[15px] text-base text-center w-[150px]"
                        shape="round"
                        color="blue_A700"
                      >
                        Approve
                ...
                <div className="bg-white-A700 flex flex-1 md:flex-col flex-row md:gap-5 items-center justify-start p-4 rounded-md shadow-bs1 w-full">
                  <Img
                ...
                <div className="bg-white-A700 flex flex-1 md:flex-col flex-row md:gap-5 items-end justify-start p-4 rounded-md shadow-bs1 w-full">
                  ...
                  <div className="flex md:flex-1 flex-col gap-5 items-end justify-start mb-0.5 md:ml-[0] ml-[209px] w-[32%] md:w-full">
                    ...
                    <div className="flex flex-row gap-4 items-center justify-between rounded-md w-full">
                      ...
                      <Button
                        className="cursor-pointer font-medium text-base text-center w-[150px]"
                        shape="round"
                        color="blue_A700"
                        size="3xl"
                      >
