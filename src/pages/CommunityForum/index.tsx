      ...
      <div className="bg-gray-50_03 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-[50px] items-start justify-between mx-auto md:px-5 w-full">
              ...
              <div className="bg-white-A700 flex flex-col md:gap-10 gap-[441px] items-center justify-end p-[5px] w-full">
                <div className="flex flex-col gap-2 items-center justify-start mt-[19px] w-[87%] md:w-full">
                  ...
                  <div className="flex flex-row gap-1.5 items-center justify-start pr-4 py-4 rounded-lg w-full">
                    ...
                    <div className="flex flex-row gap-2 items-start justify-start w-[71%]">
                      <Img
                        className="h-6 w-6"
            ...
            <div className="flex flex-1 flex-row md:gap-10 items-center justify-between md:mt-0 mt-[30px] w-full">
              <Text
              ...
              <Button
                className="cursor-pointer flex items-center justify-center min-w-[194px] pr-[18px] py-[19px]"
                leftIcon={
                  <Img
