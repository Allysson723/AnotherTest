...
const ImportPhotoshopDocumentPage: React.FC = () => {
  return (
    <>
            ...
            <div className="flex flex-col gap-6 items-center justify-start w-full">
              <div className="bg-gray-50 flex flex-col gap-3 h-[196px] md:h-auto items-center justify-center max-w-[1022px] outline outline-[2px] outline-blue-A700 sm:px-5 px-8 py-[15px] rounded-md w-full">
                ...
                <Button
                  ...
                  variant="outline"
                >
                  <div className="font-medium text-left text-sm">Import</div>
                </Button>
              </div>
              <List
              ...
              >
                <div className="flex flex-1 flex-col gap-2 items-start justify-start w-full">
                  <div className="flex md:flex-col flex-row gap-[7px] items-center justify-between w-full">
                    <div className="flex flex-row gap-[7px] items-start justify-start pr-0.5 pt-0.5">
                      <Img
                        className="h-6 md:h-auto mb-0.5 object-cover w-[2%]"
                        src="images/img_download5fo.png"
                        alt="download5fo"
                      />
                      <Text
...
export default ImportPhotoshopDocumentPage;
