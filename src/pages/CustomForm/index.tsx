...
const CustomFormPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-gray-50_05 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mx-auto md:px-5 w-full">
            ...
            <div className="flex flex-1 flex-col gap-[34px] items-center justify-start md:mt-0 mt-[59px] w-full">
              ...
              <div className="flex flex-col gap-4 items-center justify-start w-full">
                ...
                <Button
                  className="cursor-pointer font-medium py-[17px] text-base text-center w-full"
                  shape="round"
                  color="blue_A700"
                >
                  Submit
