...
const AutomatedPublishingPage: React.FC = () => {
        ...
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-[50px] items-start justify-between mx-auto md:px-5 w-full">
            ...
            <div className="flex flex-1 flex-col items-start justify-start md:mt-0 mt-8 w-full">
              ...
              <Img
                className="h-[347px] sm:h-auto mt-11 object-cover rounded-md w-full"
              ...
              <Text
                className="leading-[29.00px] mt-[23px] text-blue_gray-400 text-lg w-full"
              ...
              >
                ...
                tasks, data or files are routed between people or systems based
                on pre-defined business rules. Using enterprise workflow
                software, your business can save time and reduce errors with
                automation.
              </Text>
              <Button
                className="cursor-pointer font-medium mt-[100px] py-[19px] text-center text-lg w-[504px]"
                shape="round"
                color="blue_A700"
              >
                Publish
...
export default AutomatedPublishingPage;
