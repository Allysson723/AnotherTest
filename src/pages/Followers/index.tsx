            ...
            <div className="md:gap-5 gap-7 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center min-h-[auto] w-full">
              <div className="bg-white-A700 border border-blue_gray-50 border-solid flex flex-1 flex-col items-center justify-start p-2.5 rounded-md w-full">
                <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start w-[99%] md:w-full">
                  ...
                  <Button
                    className="cursor-pointer font-medium min-w-[83px] sm:ml-[0] ml-[78px] py-4 text-base text-center"
                    shape="round"
                    color="blue_A700"
                  >
                    Follow
              ...
              <div className="bg-white-A700 border border-blue_gray-50 border-solid flex flex-1 flex-col items-center justify-start p-2.5 rounded-md w-full">
                <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start w-[99%] md:w-full">
                  ...
                  <Button
                    className="cursor-pointer font-medium min-w-[83px] sm:ml-[0] ml-[73px] py-4 text-base text-center"
                    shape="round"
                    color="blue_A700"
                  >
                    Follow
              ...
              <div className="bg-white-A700 border border-blue_gray-50 border-solid flex flex-1 flex-col items-center justify-start p-2.5 rounded-md w-full">
                <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start w-[99%] md:w-full">
                  ...
                  <Button
                    className="cursor-pointer font-medium min-w-[83px] sm:ml-[0] ml-[78px] py-[17px] text-base text-center"
                    shape="round"
                    color="blue_A700"
                  >
                    Follow
