...
const SaveasPDFPage: React.FC = () => {
  const [inputfieldvalue, setInputfieldvalue] = React.useState<string>("");

  return (
    <>
      <div className="bg-gray-50_02 flex flex-col font-gilroy sm:gap-10 md:gap-10 gap-[60px] items-center justify-start mx-auto pb-[563px] w-full">
        ...
        <div className="flex flex-col gap-[39px] items-start justify-start max-w-[1268px] mx-auto md:px-5 w-full">
          <Text
