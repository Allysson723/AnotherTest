      ...
      <div className="bg-gray-50_03 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-[50px] items-start justify-between mx-auto md:px-5 w-full">
            ...
            <div className="flex flex-1 flex-col items-start justify-start md:mt-0 mt-[39px] w-full">
              <Text
              ...
              <Img
                className="h-[347px] sm:h-auto mt-[30px] object-cover rounded-md w-full"
                src="images/img_rectangle1388_1.png"
                alt="Rectangle1388"
              />
              <Text
                className="mt-[37px] text-2xl md:text-[22px] text-blue_gray-900 sm:text-xl"
                size="txtGilroySemiBold24"
              >
                Contents
              </Text>
              <div className="flex flex-col items-center justify-start mt-[23px] pt-0.5 w-full">
                ...
                <div className="flex flex-row md:gap-10 items-center justify-between mt-[18px] w-full">
                  <Text
                ...
                <div className="flex flex-row md:gap-10 items-center justify-between mt-[21px] w-full">
                  <Text
                    className="text-blue_gray-900 text-lg"
                    size="txtGilroySemiBold18"
                  >
                ...
                <div className="flex flex-row md:gap-10 items-end justify-between mt-[21px] w-full">
                  <Text
                ...
                <div className="flex flex-row md:gap-10 items-end justify-between mt-[18px] w-full">
                  <Text
                    className="mt-[5px] text-blue_gray-900 text-lg"
                    size="txtGilroySemiBold18"
                  >
