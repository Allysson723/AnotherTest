      ...
      <div className="bg-blue_gray-50 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        ...
        <div className="bg-white-A700 flex flex-col items-center justify-start max-w-[940px] mx-auto p-[50px] md:px-5 w-full">
          <div className="flex flex-col items-start justify-start mb-[323px] w-full">
            ...
            <div className="h-[377px] md:h-[401px] mt-6 relative w-full">
              <Text
                className="leading-[29.00px] m-auto text-blue_gray-400 text-lg"
                size="txtGilroyMedium18Bluegray400"
              >
                <>
                  As a candidate for the Webflow Developer position at 02100, I
                  would like to introduce myself as an exceptional designer with
                  a strong background in Webflow, I understand the impact that
                  good design can have. In applying for this position, I am
                  confident due to my recent job and freelance experience, as
                  well as my education.
                  <br />
                  <br />
                  As UI/UX Designer at Unseen Works DMCC, I created innovative,
                  creative, and digital experiences using a variety of software
                  and concepts. An enthusiast of Figma and web design, I excel
                  in both. I&#39;ve always had a keen eye for how things fit
                  together and do not. Other members of the team sought my
                  advice on their designs.
                  <br />
                  <br />
              ...
              <div className="absolute bg-blue-A700_4c h-[23px] left-[34%] top-[9%] w-[13%]"></div>
            </div>
